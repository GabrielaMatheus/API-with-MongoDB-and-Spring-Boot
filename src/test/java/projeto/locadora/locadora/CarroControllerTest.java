...
public class CarroControllerTest {
    ...
    public String pegaIdCarro(String placa) throws NotFoundException {
        return given().contentType(ContentType.JSON).when().get("/carros/filtrar/" + placa).then().extract().path("id");
    }
    ...
    public void givenPlaca_whenGet_Then200() throws Exception {
        ...
        given()
            .contentType(ContentType.JSON)
            .when()
            .get("/carros/"+pegaIdCarro("GGG457"))
            .then()
            .log()
            .all()
            .assertThat()
            .statusCode(200)
            .body("placa", is("GGG457"))
